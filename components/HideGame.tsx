...
export type Reveal = { pos_x: number; pos_y: number; size_pct: number; rotation: number };

export type HideDetail = {
  id: string;
  photo_url: string;
  sticker_id: string;
...
// Rendu commun à /play/[hideId] et /play/private/[code] : le zoom/pan, la
// pose de la tentative, le reveal et le partage. Les deux pages ne diffèrent
// que par la façon dont elles résolvent le detail initial (par id ou par code).
export default function HideGame({ hideId, detail, backHref, backLabel }: Props) {
